...
mat = ["бля", "хуй", "сука", "черт", "чёрт", "ебат", "пизд", "наебал", "ебал", "ебан", "заеб", "хуя", "жоп"]
...
perenos = """\u0031\uFE0F\u20E3- Выясняем причину
\u0032\uFE0F\u20E3 - Предлагаем доставку заказа в другой интервал сегодня же
\u0033\uFE0F\u20E3 - Предлагаем доставку по другому адресу, главное чтобы клиент принял сегодня `адрес согласовываем с супервайзером`
\u0033\uFE0F\u20E3.\u0031\uFE0F\u20E3 - Важно показать гибкость и лояльность компании, используя каждый раз все 3 пункта.
`так вы точно поймете, нужен ли клиенту заказ`"""
otmena = """\u0031\uFE0F\u20E3 - Отмена по просьбе клиента `крайне желательно подтверждение отмены по рабочему телефону в звонке`
\u0032\uFE0F\u20E3 - У заказа последняя-3я попытка доставки `смотрим через статус недозвон или в маршрутнике`
