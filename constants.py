...
\u0033\uFE0F\u20E3.\u0031\uFE0F\u20E3 - Покажи гибкость и лояльность компании, используя каждый раз все 3 пункта.
...
Проверь успешность платежа в iBox. Успешен? `уходим от клиента`
Выключи POS в настройках Lmexp. Отметь в точности те же позиции и тот же метод оплаты, закрой заказ.
Включи POS обратно в настройках Lmexp
